export const camelCaseConverterWithColon = (camelCaseString) => {
    const stringToArray = camelCaseString.split("");
    const arrayToString = [];
 ...
 */
export const thingToString = (property) => {
...
export const objectToString = (property) => {
    let returnString = "";
